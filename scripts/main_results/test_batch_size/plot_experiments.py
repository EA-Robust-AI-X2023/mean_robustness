from byzfl.benchmark.evaluate_results import test_accuracy_curve_modified,plot_gradients_scattering, loss_heatmap, plot_workers_feature_variance, evaluate_impact_exclusivity, evaluate_impact_subset_size, evaluate_impact_exclusivity_adaptive_bins
...
# evaluate_impact_subset_size(path_training_results,
#     path_to_plot,
#     colors=colors,
#     tab_sign=tab_sign,
#     markers=markers)
